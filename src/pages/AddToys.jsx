...
const AddToys = () => {
  ...
  return (
    <>
      <Helmet>
        <title>TinkerLand | Add A Toy</title>
      </Helmet>
      <div className="bg-cover  transformer min-h-[calc(100vh-96px)] pt-[100px] py-14 ">
        <div className="my-container  bg-white/10 p-8 rounded-lg backdrop-blur-sm">
          ...
          <p className="px-20 text-center tracking-wide py-3 text-gray-400">
            Enhance your toy collection by adding new and exciting toys. Our
            'Add Toys' page is the perfect destination for toy enthusiasts,
            collectors, and parents. Discover a diverse range of options, from
            action figures to puzzles and plush toys to board games
          </p>
